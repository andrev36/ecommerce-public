...
export const StyledContactNavIcon = styled.img.attrs((props: any) => ({
 src: `${ContactNavIcon}`,
 alt: 'contact icon'
}))`
 ${(props: DimProps) => css`
...
export const StyledProductsNavIcon = styled.img.attrs((props: any) => ({
 src: `${ProductsNavIcon}`,
 alt: 'contact icon'
}))`
 ${(props: DimProps) => css`
...
export const StyledCartNavIcon = styled.img.attrs((props: any) => ({
...
export const StyledAboutNavIcon = styled.img.attrs((props: any) => ({
...
export const StyledProfileNavIcon = styled.img.attrs((props: any) => ({
...
export const StyledProfileSettingsNavIcon = styled.img.attrs((props: any) => ({
...
export const StyledLoginNavIcon = styled.img.attrs((props: any) => ({
 src: `${LoginNavIcon}`,
 alt: 'contact icon'
}))`
 ${(props: DimProps) => css`
...
export const StyledRegisterNavIcon = styled.img.attrs((props: any) => ({
 src: `${RegisterNavIcon}`,
 alt: 'contact icon'
}))`
 ${(props: DimProps) => css`
...
export const StyledLogoutNavIcon = styled.img.attrs((props: any) => ({
 src: `${LogoutNavIcon}`,
 alt: 'contact icon'
}))`
 ${(props: DimProps) => css`
