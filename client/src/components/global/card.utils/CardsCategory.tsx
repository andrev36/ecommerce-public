   ...
   <section>
    <StyledCardCategoryWrapper>
     <StyledCardCategory side='leftSide'>
      <StyledCardCategoryImage
       src={`${protocol}://${staticPath}/static/products/product2/1.jpg`}
      />
      <StyledContainerCategoryCardText>
       <NavLink to='/products'>
     ...
     <StyledCardCategory>
      <StyledCardCategoryImage
       src={`${protocol}://${staticPath}/static/products/product1/1.jpg`}
      />
      <StyledContainerCategoryCardText>
       <NavLink to='/products'>
        <StyledButton style={{ fontSize: '17px' }}>
         Shop for female
        </StyledButton>
       </NavLink>
      </StyledContainerCategoryCardText>
